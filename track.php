<?php include 'header.php'; ?>
            ...
            <div class="contact-form-section">
               <div class="row">
                  ...
                  <div class="col-lg-6">
                     <span class="title">Package Tracking </span>
                     <h2 class="subtitle">Track Your Package </h2>
                     <form action="#" method="post">
                        <div class="row">
                           <div class="col-md-12">
                              <div class="form-element"><input type="text" name="term" placeholder="Tracking #"></div>
                           </div>
                   
                           <div class="col-md-12">
                              <div class="form-element">
                                 <button type="submit" name="save"><span>Track Package Now</span></button>
                              </div>
                           </div>
                        </div>
                     </form>
